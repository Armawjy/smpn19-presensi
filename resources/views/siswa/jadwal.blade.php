...
@section('page_subtitle', 'Seluruh jadwal pelajaran kelas Anda dalam seminggu')
...
<x-card>
    <x-table>
        ...
        @empty
            <tr>
                <td colspan="4" class="px-6 py-8 text-center text-gray-400 font-medium">Jadwal pelajaran belum tersedia.</td>
            </tr>
        @endforelse
    </x-table>
</x-card>
