...
@section('title', 'Presensi Kehadiran Anak')
@section('page_title', 'Kehadiran Anak')
@section('page_subtitle', 'Pantau catatan presensi kehadiran anak Anda di sekolah')
...
<x-card>
    <x-table>
        ...
        @forelse ($presensis as $p)
            <tr class="hover:bg-slate-50/50 transition">
                ...
                <td class="px-6 py-4 text-blue-600 font-bold font-mono">
                    ...
                    @else
                        <span class="text-xs text-gray-400 font-normal italic">Belum Pulang</span>
                    @endif
                </td>
        ...
        @empty
            <tr>
                <td colspan="6" class="px-6 py-8 text-center text-gray-400 font-medium">Data presensi kehadiran belum tersedia.</td>
            </tr>
        @endforelse
    </x-table>
</x-card>
