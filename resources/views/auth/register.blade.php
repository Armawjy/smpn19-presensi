...
<head>
    ...
    <title>Daftar - SMPN 19 Makassar</title>
    <!-- Google Fonts -->
...
<body class="bg-gradient-to-tr from-sky-600 via-primary-600 to-indigo-900 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8 shadow-2xl relative overflow-hidden">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <h1 class="text-2xl font-black text-white text-center tracking-tight leading-tight">BUAT AKUN BARU</h1>
            <p class="text-xs text-sky-200 mt-1 uppercase tracking-wider font-semibold">Khusus Pendaftaran Siswa Baru</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <!-- Nama Lengkap -->
            <div>
                <label class="block text-xs font-bold text-sky-100 uppercase tracking-wider mb-1.5">Nama Lengkap</label>
                <div class="relative">
            ...
            <!-- Password -->
            <div>
                <label class="block text-xs font-bold text-sky-100 uppercase tracking-wider mb-1.5">Password</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-sky-200">
            ...
            <!-- Konfirmasi Password -->
            <div>
                <label class="block text-xs font-bold text-sky-100 uppercase tracking-wider mb-1.5">Konfirmasi Password</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-sky-200">
        ...
        <div class="mt-6 text-center border-t border-white/10 pt-4">
            <p class="text-xs text-sky-200">
                Sudah memiliki akun? 
                <a href="{{ route('login') }}" class="text-white font-bold hover:underline transition">Masuk di sini</a>
            </p>
        </div>
